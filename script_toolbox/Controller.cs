...
public abstract class Controller : MonoBehaviour
{
    ...
    {
        return isOperable && Input.GetKeyDown(scheme.GetKeyCode(code));
    }

    protected bool Released(InputCode code)
    {
        return isOperable && Input.GetKeyUp(scheme.GetKeyCode(code));
    }

    protected bool Held(InputCode code)
    {
        return isOperable && Input.GetKey(scheme.GetKeyCode(code));
    }
